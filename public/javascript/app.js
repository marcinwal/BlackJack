         ...
         .controller('BlackJackDealerController',['$scope',function($scope){
          ...
          $scope.dealerCardsLinks = function(){
            ...
            return dealerCards[0].map(function(card,idx){
              if (idx === 0) return "cards_png/"+card+'.png';//1st uncovered
              if (!$scope.game.areAllPlayersFinished()) return "cards_png/b1fv.png";
              return "cards_png/"+card+'.png'; //all uncovered if players have finished
            });
          };
